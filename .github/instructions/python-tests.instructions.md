---
applyTo: "Tests/**/*.py"
description: "Use when writing or editing Python tests in Tests/. Enforce GIVEN/WHEN/THEN DDD comments and reuse/extend shared helpers from Tests/test_helpers.py instead of creating local Dummy/Fake classes."
---
